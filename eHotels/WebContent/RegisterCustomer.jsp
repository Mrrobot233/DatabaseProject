...
<script>
	...
	function validate() {
		...
		var confirmCustomerPassword = document.getElementById("confirmPassword");
		if(customerPassword.value != confirmCustomerPassword.value){
			alert("Your passwords must match!");
			return false;
		}
		
		if(customerID.value.length > 15){
			alert("The length of CustomerID needs to be less than 15");
			return false;
		} else
			return true;
	}
		...
		<div class="row justify-content-center align-items-center">
			<div class="main-login main-center">
				<h3 class="text-center text-black pt-5">Become a valued
				 customer!</h3>
				<form class="" method="post" action="CustomerRegisterCheck">
